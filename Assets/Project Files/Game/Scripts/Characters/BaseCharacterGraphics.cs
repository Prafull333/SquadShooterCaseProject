        ...
        public void PrepareModel()
        {
            ...
            if (tempAnimator != null)
            {
                if (tempAnimator.avatar != null && tempAnimator.avatar.isHuman)
                {
                    ...
                    // Acid Launcher
                    GameObject acidGunHolderObject = new GameObject("Acid Holder");
                    acidGunHolderObject.transform.SetParent(weaponsTransform);
                    acidGunHolderObject.transform.ResetLocal();
